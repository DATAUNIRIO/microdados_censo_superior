local<-"C:\\Users\\Steven\\Desktop\\Microdados\\INEP\\Microdados_2015"
setwd(local)
getwd()
...
ALUNO<-read.csv2.ffdf(file="C:/Users/Steven/Desktop/Microdados/INEP/Microdados_2015/microdados_censo_superior_2015/DADOS/DM_ALUNO.CSV",sep="|",first.rows=1000000)
#É importante que o Pipe( | ) seja utilizado como delimitador.

#---------------------------------------------------------------------
# Somente a UNIRIO
#---------------------------------------------------------------------
ALUNO_UNIRIO15 <- subset(ALUNO , CO_IES == 693)
ALUNO_UNIRIO15 <- data.frame(ALUNO_UNIRIO15)
saveRDS(ALUNO_UNIRIO15,"ALUNO_UNIRIO15.RDS")
#---------------------------------------------------------------------
...
ALUNO_UNIVERSIDADE_RJ_15<- subset(ALUNO , CO_IES == 693 | CO_IES ==  15 | CO_IES == 140 | 
...
ALUNO_UNIVERSIDADE_RJ_15 <- data.frame(ALUNO_UNIVERSIDADE_RJ_15)

saveRDS(ALUNO_UNIVERSIDADE_RJ_15,"ALUNO_UNIVERSIDADE_RJ_15.RDS")

#----------------------------------------------------------------------------------------------------------------------------------

local<-"C:/Users/Steven/Documents/GitHub/microdados_censo_superior/dados/2015/ALUNO_UNIVERSIDADE_RJ_15.RDS"
ALUNO_UNIVERSIDADE_RJ_15<-readRDS(local)
# Eliminar os niveis dos fatores nao utilizado (drop factor levels in a dataset)
ALUNO_UNIVERSIDADE_RJ_15<-droplevels(ALUNO_UNIVERSIDADE_RJ_15)

library(tibble)
ALUNO_UNIVERSIDADE_RJ_15<-tibble(ALUNO_UNIVERSIDADE_RJ_15)
saveRDS(ALUNO_UNIVERSIDADE_RJ_15,"ALUNO_UNIVERSIDADE_RJ_15.RDS")
getwd()
