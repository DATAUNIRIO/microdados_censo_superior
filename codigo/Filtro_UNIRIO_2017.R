local<-"C:\\Users\\Steven\\Desktop\\Microdados\\Microdados_2017"
setwd(local)
getwd()
...
ALUNO<-read.csv2.ffdf(file="C:/Users/Steven/Desktop/Microdados/Microdados_2017/Microdados_Educacao_Superior_2017/DADOS/DM_ALUNO/DM_ALUNO.CSV",sep="|",first.rows=1000000)
#É importante que o Pipe( | ) seja utilizado como delimitador.

#---------------------------------------------------------------------
# Somente a UNIRIO
#---------------------------------------------------------------------
ALUNO_UNIRIO17 <- subset(ALUNO , CO_IES == 693)
ALUNO_UNIRIO17 <- data.frame(ALUNO_UNIRIO17)
saveRDS(ALUNO_UNIRIO17,"ALUNO_UNIRIO17.RDS")
...
ALUNO_UNIVERSIDADE_RJ_17<- subset(ALUNO , CO_IES == 693 | CO_IES ==  15 | CO_IES == 140 | 
...
ALUNO_UNIVERSIDADE_RJ_17 <- data.frame(ALUNO_UNIVERSIDADE_RJ_17)

saveRDS(ALUNO_UNIVERSIDADE_RJ_17,"ALUNO_UNIVERSIDADE_RJ_17.RDS")
